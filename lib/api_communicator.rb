  ...
  while character_hash["next"] != nil
    ...
    character_hash["results"].find do |data|
      ...
      if data["name"] == character
        ...
        character_hash = JSON.parse(RestClient.get(character_hash["next"])) if character_hash["next"] != nil
